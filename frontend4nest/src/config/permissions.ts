export const ALL_PERMISSIONS = {
    ...
    PROJECTS: {
        GET_PAGINATE: { method: "GET", apiPath: '/api/v1/projects', module: "PROJECTS" },
        CREATE: { method: "POST", apiPath: '/api/v1/projects', module: "PROJECTS" },
        UPDATE: { method: "PATCH", apiPath: '/api/v1/projects/:id', module: "PROJECTS" },
        DELETE: { method: "DELETE", apiPath: '/api/v1/projects/:id', module: "PROJECTS" },
    },
    JOBS: {
