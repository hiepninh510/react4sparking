...
const LayoutAdmin = () => {
    ...
    useEffect(() => {
        if (permissions?.length) {
            ...
            const viewProject = permissions.find(item =>
                item.apiPath === ALL_PERMISSIONS.PROJECTS.GET_PAGINATE.apiPath
                && item.method === ALL_PERMISSIONS.PROJECTS.GET_PAGINATE.method
            )
            ...
            const full = [
                ...
                ...(viewProject ? [{
                    label: <Link to='/admin/project'>Project</Link>,
                    key: '/admin/project',
