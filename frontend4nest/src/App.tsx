...
import ClientProjectPage from './pages/project';
import ClientProjectDetailPage from './pages/project/detail';
  ...
  const router = createBrowserRouter([
    {
      ...
      children: [
        ...
        { path: "project", element: <ClientProjectPage /> },
        { path: "project/:id", element: <ClientProjectDetailPage /> }
